...
namespace THTOneMobile.Classes
{
    class ClsPrint
    {
        ...
        public ClsPrint(DataGridView gridview, string ReportHeader, string date)
        {
        ...
        private void _printDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            while (iRow <= gw.Rows.Count - 1)
            {
                ...
                else
                {
                    ...
                    foreach (DataGridViewCell gridcell in gw.Rows[iRow].Cells)
                    {
                        if (gridcell.Value != null)
                        {
                            e.Graphics.DrawString(gridcell.FormattedValue.ToString(),
                                gridcell.InheritedStyle.Font,
                                new SolidBrush(gridcell.InheritedStyle.ForeColor),
